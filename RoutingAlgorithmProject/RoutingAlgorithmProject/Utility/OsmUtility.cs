...
namespace RoutingAlgorithmProject.Utility
{
    public static class OsmUtility
    {
        ...
        {
            Graph.Graph g = new Graph.Graph();
            Graph.Vertex a = g.AddVertex(new MapPoint(0, 0));
            Graph.Vertex b = g.AddVertex(new MapPoint(0, 10));
            Graph.Vertex c = g.AddVertex(new MapPoint(5, 5));
            Graph.Vertex d = g.AddVertex(new MapPoint(10, 10));
